...
function dictValueParserNewUserItem(): DictionaryValue<NewUserItem> {
 ...
 type ShortLink_init_args = {
    $$type: 'ShortLink_init_args';
    parent: Address;
    id: bigint;
}

function initShortLink_init_args(src: ShortLink_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
async function ShortLink_init(parent: Address, id: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initShortLink_init_args({ $$type: 'ShortLink_init_args', parent, id })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const ShortLink_errors: { [key: number]: { message: string } } = {
...
const ShortLink_getters: ABIGetter[] = [
    {"name":"counter","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const ShortLink_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewLike"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class ShortLink implements Contract {
    
    static async init(parent: Address, id: bigint) {
        return await ShortLink_init(parent, id);
    }
    
    static async fromInit(parent: Address, id: bigint) {
        const init = await ShortLink_init(parent, id);
        const address = contractAddress(0, init);
        return new ShortLink(address, init);
    }
    
    static fromAddress(address: Address) {
        return new ShortLink(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ShortLink_types,
        getters: ShortLink_getters,
        receivers: ShortLink_receivers,
        errors: ShortLink_errors,
    };
