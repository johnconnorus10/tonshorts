...
function dictValueParserTSDetails(): DictionaryValue<TSDetails> {
 ...
 type TShortsUserItem_init_args = {
    $$type: 'TShortsUserItem_init_args';
    parent: Address;
    user: Address;
    id: bigint;
...
function initTShortsUserItem_init_args(src: TShortsUserItem_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
async function TShortsUserItem_init(parent: Address, user: Address, id: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initTShortsUserItem_init_args({ $$type: 'TShortsUserItem_init_args', parent, user, id })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const TShortsUserItem_errors: { [key: number]: { message: string } } = {
...
const TShortsUserItem_types: ABIType[] = [
...
const TShortsUserItem_getters: ABIGetter[] = [
    {"name":"details","arguments":[],"returnType":{"kind":"simple","type":"TSDetails","optional":false}},
    {"name":"videoId","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"dt","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const TShortsUserItem_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewUserItem"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InternalComplete"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class TShortsUserItem implements Contract {
    
    static async init(parent: Address, user: Address, id: bigint) {
        return await TShortsUserItem_init(parent, user, id);
    }
    
    static async fromInit(parent: Address, user: Address, id: bigint) {
        const init = await TShortsUserItem_init(parent, user, id);
        const address = contractAddress(0, init);
        return new TShortsUserItem(address, init);
    }
    
    static fromAddress(address: Address) {
        return new TShortsUserItem(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  TShortsUserItem_types,
        getters: TShortsUserItem_getters,
        receivers: TShortsUserItem_receivers,
        errors: TShortsUserItem_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: NewUserItem | InternalComplete | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'NewUserItem') {
            body = beginCell().store(storeNewUserItem(message)).endCell();
        }
    ...
    async getDetails(provider: ContractProvider) {
        ...
        const result = loadTupleTSDetails(source);
        return result;
    }
    
    async getVideoId(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('videoId', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    
    async getDt(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('dt', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
