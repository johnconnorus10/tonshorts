...
function dictValueParserTSDetails(): DictionaryValue<TSDetails> {
 ...
 type TShortsUser_init_args = {
    $$type: 'TShortsUser_init_args';
    parent: Address;
    user: Address;
}

function initTShortsUser_init_args(src: TShortsUser_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
async function TShortsUser_init(parent: Address, user: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initTShortsUser_init_args({ $$type: 'TShortsUser_init_args', parent, user })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const TShortsUser_errors: { [key: number]: { message: string } } = {
...
const TShortsUser_types: ABIType[] = [
...
const TShortsUser_getters: ABIGetter[] = [
    {"name":"itemAddress","arguments":[{"name":"id","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":false}},
    {"name":"counter","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

const TShortsUser_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewUser"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class TShortsUser implements Contract {
    
    static async init(parent: Address, user: Address) {
        return await TShortsUser_init(parent, user);
    }
    
    static async fromInit(parent: Address, user: Address) {
        const init = await TShortsUser_init(parent, user);
        const address = contractAddress(0, init);
        return new TShortsUser(address, init);
    }
    
    static fromAddress(address: Address) {
        return new TShortsUser(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  TShortsUser_types,
        getters: TShortsUser_getters,
        receivers: TShortsUser_receivers,
        errors: TShortsUser_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: NewUser | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'NewUser') {
            body = beginCell().store(storeNewUser(message)).endCell();
        }
    ...
    async getItemAddress(provider: ContractProvider, id: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(id);
        let source = (await provider.get('itemAddress', builder.build())).stack;
