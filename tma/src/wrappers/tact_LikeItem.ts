...
function initLikeItem_init_args(src: LikeItem_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
...
async function LikeItem_init(parent: Address, id: bigint, from: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initLikeItem_init_args({ $$type: 'LikeItem_init_args', parent, id, from })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const LikeItem_errors: { [key: number]: { message: string } } = {
...
const LikeItem_getters: ABIGetter[] = [
...
const LikeItem_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"NewLike"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class LikeItem implements Contract {
    
    static async init(parent: Address, id: bigint, from: Address) {
        return await LikeItem_init(parent, id, from);
    }
    
    static async fromInit(parent: Address, id: bigint, from: Address) {
        const init = await LikeItem_init(parent, id, from);
        const address = contractAddress(0, init);
        return new LikeItem(address, init);
    }
    
    static fromAddress(address: Address) {
        return new LikeItem(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  LikeItem_types,
        getters: LikeItem_getters,
        receivers: LikeItem_receivers,
        errors: LikeItem_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: NewLike | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'NewLike') {
            body = beginCell().store(storeNewLike(message)).endCell();
        }
